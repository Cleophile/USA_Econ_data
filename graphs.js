...
var gdp_data_set = function(gdp_data){
    var gdp = [];
    var date = [];
...
var month_data_set = function(month_data){
...
files.addEventListener("change", function () {
    try{
        ...
        reader.onload = function () {
            ...
            if (gdp_data['real_gdp'] === undefined)
                month_data_set(gdp_data);
            else
                gdp_data_set(gdp_data);
        }
        ...
        small_reader.onload = function () {
            ...
            if (month_data['real_gdp'] === undefined)
                month_data_set(month_data);
            else
                gdp_data_set(month_data);
        }
    }catch(error)
    {
